...
echo "It‰kordinaattien maksimiarvo ",$Imaxarvo,"<br><br>";
echo  "Pohjoiskordinattien keskiarvo ",$Pkeskiarvo,"<br>";
echo "It‰kordinaattien keskiarvo ",$Ikeskiarvo,"<br><br>";
echo "Pohjoiskordinattien  minimiarvo ",$Pminarvo,"<br>";
echo "It‰kordinaattien minimiarvo ",$Iminarvo,"<br><br>";

echo "Statsien rivien m‰‰r‰ ", "$num","<br>";
echo "Kordinaattien rivien m‰‰r‰ ", "$num2","<br><br>";
?>
...
"toimivat ohjeet lˆytyy http://www.tizag.com/ajaxTutorial/ajax-mysql-database.php";
...
$target = mktime(0, 0, 0, 12, 31, 2014) ;
$today = time () ;
